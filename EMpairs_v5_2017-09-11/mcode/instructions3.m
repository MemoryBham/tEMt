...
for it = 1:params.Ins.numFrames(1)
    ...
    DrawFormattedText( params.window, params.instructions3.a, 'center',  params.yCenter-50, [.25 .25 .25]);
    DrawFormattedText( params.window, params.instructions3.b, 'center', params.yCenter+50, [.25 .25 .25]);
    DrawFormattedText( params.window, params.instructions3.c, 'center',  params.yCenter+100, [.25 .25 .25]);
...
DrawFormattedText( params.window, params.instructions3.b, 'center',  params.yCenter+50, [.25 .25 .25]);
DrawFormattedText( params.window, params.instructions3.c, 'center',  params.yCenter+100, [.25 .25 .25]);
DrawFormattedText( params.window, params.instructions3.d, 'center',  params.yCenter+150, [.25 .25 .25]);
